...
const CreateCouponScreen = () => {
    ...
    const renderItem = ({ item }) => (
        <BouncyCheckbox
            ...
            textStyle={{ fontFamily: fonts.regular, color: themes?.white, fontSize: wp(3.5) }}
    ...
    return (
        <Wrapper>
            <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
                ...
                <View style={styles.row}>
                    ...
                    <View style={{ width: wp(65) }}>
                        <BouncyCheckbox
                            ...
                            iconStyle={{ borderColor: themes?.red1 }}
                            textStyle={{ fontFamily: fonts.lexendSemiBold, color: themes?.white, fontSize: wp(3.5), textDecorationLine: 'none' }}
                ...
                <View style={styles.whiteLine} />
                <Text style={[styles.couponText, { marginBottom: hp(2) }]}>Description</Text>
                <CustomInput
                    value={name}
                    setValue={setName}
                    width={wp(90)}
                ...
                />
                <View style={styles.whiteLine} />
                <Text style={[styles.couponText, { marginBottom: hp(2) }]}>Select Cruisine</Text>
                <FlatList
                    data={cruisineData}
                    keyExtractor={item => item?.id}
                    renderItem={renderItem}
                ...
                />
                <Text style={[styles.couponText, { marginBottom: hp(2) }]}>Add Image</Text>
